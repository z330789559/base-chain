...
pub trait EthApi {
	...
	#[rpc(name = "ccm_protocolVersion")]
	fn protocol_version(&self) -> Result<u64>;

	/// Returns an object with data about the sync status or false. (wtf?)
	#[rpc(name = "ccm_syncing")]
	fn syncing(&self) -> Result<SyncStatus>;

	/// Returns the number of hashes per second that the node is mining with.
	#[rpc(name = "ccm_hashrate")]
	fn hashrate(&self) -> Result<U256>;

	/// Returns block author.
	#[rpc(name = "ccm_coinbase")]
	...
	#[rpc(name = "ccm_getLogs")]
	fn logs(&self, _: Filter) -> Result<Vec<Log>>;

	/// Returns the hash of the current block, the seedHash, and the boundary condition to be met.
	#[rpc(name = "ccm_getWork")]
	fn work(&self) -> Result<Work>;

	/// Used for submitting a proof-of-work solution.
	#[rpc(name = "ccm_submitWork")]
	fn submit_work(&self, _: H64, _: H256, _: H256) -> Result<bool>;

	/// Used for submitting mining hashrate.
	#[rpc(name = "ccm_submitHashrate")]
